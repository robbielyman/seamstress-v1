...
pub fn build(b: *std.Build) void {
    ...
    exe.addObjectFile("/opt/homebrew/opt/rtmidi/lib/librtmidi.a");
    exe.addObjectFile("/usr/local/lib/liblo.a");
    exe.addObjectFile("/opt/homebrew/opt/ncurses/lib/libcurses.a");
    exe.addObjectFile("/opt/homebrew/opt/readline/lib/libreadline.a");
    exe.addObjectFile("/opt/homebrew/opt/readline/lib/libhistory.a");
    exe.linkLibC();
    exe.linkLibCpp();

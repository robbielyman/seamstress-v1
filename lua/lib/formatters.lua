--- Formatters, to have custom rendering of param values as text
--
-- @module Formatters

-- written as norns' formatters.lua
-- @author antonhornquist & tehn & markwheeler & pq & scazan
-- norns formatters.lua first committed by @antonhornquist April 6, 2018

...
S.__add = function(a, b)
  return S.func(a, S._fns.add, b)
end
S.__sub = function(a, b)
  return S.func(a, S._fns.sub, b)
end
S.__mul = function(a, b)
  return S.func(a, S._fns.mul, b)
end
S.__div = function(a, b)
  return S.func(a, S._fns.div, b)
end
S.__mod = function(a, b)
  return S.func(a, S._fns.mod, b)
end
...
local function do_step(s)
  ...
  if retval == "skip" or retval == "dead" then
    return S.next(s)
  end
  return retval, exec
end
...
function S.next(s)
  if do_flow(s, "every") then
    return "skip"
  end
  if do_flow(s, "times") then
    return "dead"
  end
